        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500">Create</span>
                </div>
            </li>
        </ol>
    </x-slot>
    <x-slot name="header">
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="toolbar-buttons flex justify-end">
                <button type="submit" class="success-btn" form="form1">Save</button>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form id="form1" action="{{ route('admin.pages.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="toggle-example" class="flex relative items-center mb-4 cursor-pointer">
                                <input type="checkbox" id="toggle-example" class="sr-only" name="active" checked
                                    value="1">
                                <div
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="page_title" name="page_title" class="input-text"
                                placeholder="Page Title..." required value="{{ old('page_title') }}">
                            @error('page_title')
                        ...
                        <div class="flex flex-col">
                            ...
                            <textarea id="summernote" name="html_content">{!! old('html_content') !!}</textarea>
                        </div>
                        <div class="mt-6">
