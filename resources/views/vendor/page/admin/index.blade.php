    ...
    <x-slot name="header">
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="toolbar-buttons flex justify-end">
                <a href="{{ route('admin.pages.create') }}" type="button" class="primary-btn">Create</a>
            </div>
        </div>
    </x-slot>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500">Pages</span>
                </div>
            </li>
        </ol>
    </x-slot>
